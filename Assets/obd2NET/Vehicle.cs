...
namespace obd2NET
{
    ...
    public static class Vehicle
    {
		...
		public static IOBDConnection obdConnection = new TcpConnection("127.0.0.1", 13000);
		/// <summary>
        ...
        public static String EngineTemperature()
        {
        ...
        public static uint ThrottlePosition()
        {
        ...
        public static uint CalculatedEngineLoadValue()
        {
        ...
        public static uint FuelPressure()
        {
        ...
        public static bool MalfunctionIndicatorLamp()
        {
        ...
        public static List<DiagnosticTroubleCode> DiagnosticTroubleCodes()
        {
